 ...
 ************************************************************************ */
export default async function initializeRuleEngineWorker(
  formDef,
  renderHTMLForm,
) {
  ...
  const path =
    window.location.hostname.indexOf("adobeaemcloud") > 0
      ? "/content/tcs.resource"
      : window.hlx.codeBasePath;
  const myWorker = new Worker(`${path}/blocks/form/rules/RuleEngineWorker.js`, {
    type: "module",
  });
